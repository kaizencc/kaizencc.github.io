      ...
      <EuiPage restrictWidth={true}>
        ...
        <EuiPageBody component='div'>
          ...
          <PageSection title='About Me'>
            <EuiText>
              <p>
                <EuiIcon type={williamsSvg} size="l" />
                // why is this not a comment lol <EuiImage size="l" alt='some text' url={'Williams1.png'} />

                I am a junior at <b>Williams College</b> pursuing a bachelor of arts in Computer Science.
              </p>
              <p>
                <center><EuiIcon type="logoAWS" size="l" /></center>
              </p>
              <p>
                I will be interning at <b>Amazon Web Services</b> this summer as part of the <b>Cloud Development Kit</b> team.
                I am beyond excited for this opportunity and am looking to get my hands dirty in the form of a Fall Software Engineering Internship
                as well.
              </p>
              <p>
                <center>
                <EuiIcon type={juniSvg} size="original" />
                //<EuiImage size="l" alt='some text' url={'./juni1.png'} />
                </center>
              </p>
              <p>
                During the school year, I teach computer science online as a <b>Senior Instructor</b> at
                <b>Juni Learning</b>.
                I help my kids develop skills in <b>Python</b> and <b>Java</b>, and I develop our top students for the USA Computing Olympiad.
                Outside of teaching, I moonlight as a Python curriculum developer and recruitment coordinator for Juni Learning.
                Some of the projects I have created and taught are a <b>Tic-Tac-Toe AI</b> that never loses, as well as a simulation of
                <b> Conways Game of Life</b>.
              </p>
              <p>
                Lets connect! Feel free to contact me at zen.conroy@gmail.com.
